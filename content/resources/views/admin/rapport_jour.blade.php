    ...
    <div class="card-content">
        <div class="row row-group m-0">
            <div class="col-12 col-lg-6 col-xl-2 border-light">
                <div class="card-body">
                  <h5 class="text-white mb-0" style="font-size:12px">Chiffre d'Affaire du Jour  <span class="float-right"><i class="fa fa-dollar"></i></span></h5>
 ...
 <div class="row">
                    ...
                    <table class="table table-sm table-bordered" style="font-size:12px;">
                        ...
                        <tbody>
                            ...
                            @foreach($magasins as $mag)
                                ...
                                @endphp
                                <tr>
                                    <td style="font-weight:bold;">{{ $mag->nom_mag }}</td>
    ...
    @empty
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title" style="font-size:14px;">
                    <i class="fa fa-shopping-cart"></i> Aucune Vente 
                </h5>
            </div>
        </div>
        </div>
...
<script>
    document.getElementById('toggleVentesBtn').addEventListener('click', function() {
        var ventesTable = document.getElementById('ventesTable');
        if (ventesTable.style.display === "none") {
            ventesTable.style.display = "block";
        } else {
            ventesTable.style.display = "none";
        }
    });
</script>
...
<script>
    document.getElementById('togglelivraison').addEventListener('click', function() {
        var ventesTable = document.getElementById('livraisontable');
        if (ventesTable.style.display === "none") {
            ventesTable.style.display = "block";
        } else {
            ventesTable.style.display = "none";
